...
import { LayoutGrid, KanbanSquare, Inbox, CheckSquare, CalendarDays, MoreHorizontal, Users, Building2, FolderOpen, Megaphone, LifeBuoy, X } from 'lucide-react'
...
const MORE_PAGES: Page[] = ['contacts', 'properties', 'documents', 'marketing']
