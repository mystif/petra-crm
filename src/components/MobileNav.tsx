...
import { LayoutGrid, KanbanSquare, Inbox, CheckSquare, CalendarDays, MoreHorizontal, Users, Building2, FolderOpen, Megaphone, Settings, LifeBuoy, PhoneCall, Star, X } from 'lucide-react'
...
const MORE_PAGES: Page[] = ['contacts', 'tasks', 'documents', 'coldcall', 'recenze', 'marketing', 'settings']
        ...
        <div className="fixed inset-0 z-40 md:hidden" onClick={() => setMoreOpen(false)}>
          ...
          >
            ...
            <div className="px-3 pb-3">
              ...
              <SheetRow icon={Star} label="Recenze" active={current === 'recenze'} onClick={() => go('recenze')} />
